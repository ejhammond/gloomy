...
export type SimpleAspect =
  | { type: 'add-target'; value?: undefined }
  | { type: 'add-blessing'; value?: undefined }
  | { type: 'add-curse'; value?: undefined }
  | { type: 'critical'; value?: undefined }
  | { type: 'miss'; value?: undefined }
  | { type: 'blessing'; value?: undefined }
  | { type: 'curse'; value?: undefined }
  | { type: 'refresh-item'; value?: undefined };
...
export type AttackModifierCardAspect = SimpleAspect | NumericalAspect | InfuseAspect | StatusAspect;
