...
export const classesById = {
  ...
  [bladeswarm.id]: bladeswarm,
  [brute.id]: brute,
  [cragheart.id]: cragheart,
  [doomstalker.id]: doomstalker,
  [elementalist.id]: elementalist,
  [mindthief.id]: mindthief,
  [nightshroud.id]: nightshroud,
  [plagueherald.id]: plagueherald,
  [quartermaster.id]: quartermaster,
  [sawbones.id]: sawbones,
  [scoundrel.id]: scoundrel,
  [soothsinger.id]: soothsinger,
  [spellweaver.id]: spellweaver,
